...
public class EmailService {
	...
	protected String mailEmailFrom = "robertpod.ww1@gmail.com";
	protected String username = "robertpod.ww1@gmail.com";
	protected String password = "R0bertTest";
	...
	public boolean sendEmail(String recipientEmail, String subject, String content) {
		...
		try {
			...
			// tutaj należy obsłużyć wyjątek - zobacz
			// http://kobietydokodu.pl/niezbednik-juniora-wyjatki-i-ich-obsluga/
		}
