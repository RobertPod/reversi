...
// by http://howtodoinjava.com/security/how-to-generate-secure-password-hash-md5-sha-pbkdf2-bcrypt-examples/
...
public class ReallyStrongSecuredPassword {
	 ...
	 * InvalidKeySpecException { String originalPassword = "password"; String
